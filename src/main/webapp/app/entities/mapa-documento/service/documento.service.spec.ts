...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../mapa-documento.test-samples';

import { DocumentoService, RestDocumento } from './documento.service';

const requireRestSample: RestDocumento = {
  ...sampleWithRequiredData,
  fechaElaboracion: sampleWithRequiredData.fechaElaboracion?.toJSON(),
