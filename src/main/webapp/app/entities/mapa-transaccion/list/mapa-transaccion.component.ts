...
@Component({
  ...
  templateUrl: './mapa-transaccion.component.html',
  styleUrls: ['./mapa-transaccion.component.scss'],
})
export class TransaccionComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.activatedRoute.queryParams.subscribe(params => {
      ...
      this.descripcionproceso = params['descripcionproceso'];
      this.descripciontipodocumento = params['descripciontipodocumento'];
    });
    this.load();
  }
